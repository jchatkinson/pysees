...
> Required Notice: Copyright (c) 2026 Jeremy Atkinson (https://pysees.app)
...
**Operating or providing access to a hosted, deployed, or
otherwise publicly reachable instance of the software or any
substantial portion of it (for example, on a website, SaaS
product, or other network service made available to third
parties) is not a permitted purpose, whether or not you charge
for that access.**
...
Want to use PySees commercially, or host a public instance of
it? Get in touch to discuss a commercial license.
